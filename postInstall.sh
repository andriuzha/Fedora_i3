...
sudo dnf -y install htop vim ranger cmus mpv light libtxc_dxtn lxappearance zathura zathura-pdf-mupdf links p7zip p7zip-plugins cava ffmpegthumbnailer tumbler thunar-archive-plugin xarchiver google-chrome-stable
...
echo "Presiona Enter patra reiniciar"
